// ─────────────────────────────────────────
// HYPERION LAYER v1.0
// Complete neural network layer with
// output reduction — true dot product
// input × weight + bias → ReLU
// All 16 inputs contribute to each output
// ─────────────────────────────────────────
...
module hyperion_layer (
    ...
    // all 256 outputs from systolic array
    wire signed [15:0] r0c0,r0c1,r0c2,r0c3,r0c4,r0c5,r0c6,r0c7;
    wire signed [15:0] r0c8,r0c9,r0c10,r0c11,r0c12,r0c13,r0c14,r0c15;
    ...
    // after reduction
    wire signed [15:0] red0,red1,red2,red3;
    wire signed [15:0] red4,red5,red6,red7;
    wire signed [15:0] red8,red9,red10,red11;
    wire signed [15:0] red12,red13,red14,red15;
    ...
    // ── STAGE 2: REDUCTION UNIT ──
    reduction_unit reduce (
        ...
        .r15c8(r15c8),.r15c9(r15c9),.r15c10(r15c10),.r15c11(r15c11),
        .r15c12(r15c12),.r15c13(r15c13),.r15c14(r15c14),.r15c15(r15c15),
        .out0(red0),  .out1(red1),  .out2(red2),  .out3(red3),
        .out4(red4),  .out5(red5),  .out6(red6),  .out7(red7),
        .out8(red8),  .out9(red9),  .out10(red10),.out11(red11),
        .out12(red12),.out13(red13),.out14(red14),.out15(red15)
    );

    // ── STAGE 3: BIAS UNIT ──
    bias_unit bias_add (
        .clk(clk),.reset(reset),.enable(bias_enable),
        .in0(red0),  .in1(red1),  .in2(red2),  .in3(red3),
        .in4(red4),  .in5(red5),  .in6(red6),  .in7(red7),
        .in8(red8),  .in9(red9),  .in10(red10),.in11(red11),
        .in12(red12),.in13(red13),.in14(red14),.in15(red15),
