module gpt2_full_test;
    ...
    hyperion_gpt2_full dut (
        .clk(clk),.reset(reset),.start(start),.pos(pos),
        .x0(x0),.x1(x1),.x2(x2),.x3(x3),
        .x4(x4),.x5(x5),.x6(x6),.x7(x7),
        .ga_a_b1_wq0(wq0),.ga_a_b1_wq1(wq1),.ga_a_b1_wq2(wq2),.ga_a_b1_wq3(wq3),
        .ga_a_b1_wq4(wq4),.ga_a_b1_wq5(wq5),.ga_a_b1_wq6(wq6),.ga_a_b1_wq7(wq7),
        .ga_a_b1_wk0(wk0),.ga_a_b1_wk1(wk1),.ga_a_b1_wk2(wk2),.ga_a_b1_wk3(wk3),
        .ga_a_b1_wk4(wk4),.ga_a_b1_wk5(wk5),.ga_a_b1_wk6(wk6),.ga_a_b1_wk7(wk7),
        .ga_a_b1_wv0(wv0),.ga_a_b1_wv1(wv1),.ga_a_b1_wv2(wv2),.ga_a_b1_wv3(wv3),
        .ga_a_b1_wv4(wv4),.ga_a_b1_wv5(wv5),.ga_a_b1_wv6(wv6),.ga_a_b1_wv7(wv7),
        .ga_a_b1_w1_0(w1_0),.ga_a_b1_w1_1(w1_1),.ga_a_b1_w1_2(w1_2),.ga_a_b1_w1_3(w1_3),
        .ga_a_b1_w1_4(w1_4),.ga_a_b1_w1_5(w1_5),.ga_a_b1_w1_6(w1_6),.ga_a_b1_w1_7(w1_7),
        .ga_a_b1_b1_0(b1_0),.ga_a_b1_b1_1(b1_1),.ga_a_b1_b1_2(b1_2),.ga_a_b1_b1_3(b1_3),
        .ga_a_b1_b1_4(b1_4),.ga_a_b1_b1_5(b1_5),.ga_a_b1_b1_6(b1_6),.ga_a_b1_b1_7(b1_7),
        .ga_a_b1_w2_0(w2_0),.ga_a_b1_w2_1(w2_1),.ga_a_b1_w2_2(w2_2),.ga_a_b1_w2_3(w2_3),
        .ga_a_b1_w2_4(w2_4),.ga_a_b1_w2_5(w2_5),.ga_a_b1_w2_6(w2_6),.ga_a_b1_w2_7(w2_7),
        .ga_a_b1_b2_0(b2_0),.ga_a_b1_b2_1(b2_1),.ga_a_b1_b2_2(b2_2),.ga_a_b1_b2_3(b2_3),
        .ga_a_b1_b2_4(b2_4),.ga_a_b1_b2_5(b2_5),.ga_a_b1_b2_6(b2_6),.ga_a_b1_b2_7(b2_7),
    ...
    always @(posedge clk) begin
        if (done && !last_done) begin
            $display("══════════════════════════════════════════");
            $display("HYPERION GPT-2 FULL PIPELINE");
            $display("PE → 12 transformer blocks");
            $display("══════════════════════════════════════════");
            $display("");
            ...
            $display("  ✓ Positional encoding (pos=%0d)", pos);
            $display("  ✓ 12 transformer blocks");
            $display("");
            $display("══════════════════════════════════════════");
            $display("Hyperion GPT-2 full pipeline complete!");
            $display("This is the complete GPT-2 architecture.");
