module trainer_debug;

    reg clk, reset, start;

    // simple test — one forward pass, check all intermediate values
    ...
    wire signed [7:0]  w_new0;
    wire signed [15:0] out0,loss;
    wire done;

    // assign other targets to 0
    wire signed [15:0] t1=0,t2=0,t3=0,t4=0,t5=0,t6=0,t7=0;
    wire signed [15:0] t8=0,t9=0,t10=0,t11=0,t12=0,t13=0,t14=0,t15=0;
    wire signed [7:0]  w_new1,w_new2,w_new3,w_new4,w_new5,w_new6,w_new7;
    wire signed [7:0]  w_new8,w_new9,w_new10,w_new11,w_new12,w_new13,w_new14,w_new15;
    wire signed [15:0] out1,out2,out3,out4,out5,out6,out7;
    ...
    // print every clock cycle to see what's happening
    always @(posedge clk) begin
        if (trainer.state != 0)
            $display("  t=%0t state=%0d cycle=%0d out0=%0d loss=%0d dw0=%0d w_new0=%0d",
                $time,
                trainer.state,
                trainer.cycle_count,
                out0, loss,
    ...
    initial begin
        ...
        @(posedge done); #1;
        $display("");
        $display("Final: out0=%0d loss=%0d w0=%0d w_new0=%0d",
            out0, loss, w0, w_new0);
        $finish;
    end
